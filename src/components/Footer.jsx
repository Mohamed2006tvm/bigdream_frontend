      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="col-span-1">
            <Link to="/" className="text-3xl font-normal text-brand-primary font-display block mb-4">My dream surprise</Link>
        ...
        <div className="border-t border-slate-200/60 pt-8 text-center flex items-center justify-center">
          <p className="text-slate-400 text-[11px] font-medium tracking-wide">© 2026 My dream surprise. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
